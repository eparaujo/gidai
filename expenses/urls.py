...
urlpatterns = [
    ...
    path('api/v1/expenses/', views.ExpenseCreateListApiView.as_view(), name='expense-create-list-api-view'),
    path('api/v1/expenses/<int:pk>/', views.ExpenseRetrieveUpdateDestroyApiView.as_view(), name='expense-retrieve-list-api-view'),
]